 ...
 *
 *
 * Note that the precise value returned by [.getMaxDepth] may change over time, but it
 * can be assumed that `SMALL <= MEDIUM <= LARGE <= FULL`.
 */
actual enum class KStackSize {
    /**
     ...
     * [GoogleLoggingApi.withStackTrace] in conjunction with rate limiting methods,
 ...
 */
actual val KStackSize.maxDepth: Int get() = TODO()
