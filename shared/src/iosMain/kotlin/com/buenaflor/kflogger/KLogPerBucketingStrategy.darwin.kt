...
actual abstract class KLogPerBucketingStrategy<T> protected actual constructor(name: String?) {
    /**
     ...
     * values is small, the set of distinct allocated instances passed to [ ][LoggingApi.per] can be unbounded, and that's what matters. As
    ...
    actual companion object {
         ...
         */
        actual fun knownBounded(): KLogPerBucketingStrategy<Any> {
         ...
         */
        actual fun byClass(): KLogPerBucketingStrategy<Any> {
            TODO("Not yet implemented")
        }
         ...
         * rare.
         */
        actual fun byClassName(): KLogPerBucketingStrategy<Any> {
            TODO("Not yet implemented")
        }
         ...
         */
        actual fun forKnownKeys(knownKeys: Iterable<*>): KLogPerBucketingStrategy<Any> {
            TODO()
        }
         ...
         */
        actual fun byHashCode(maxBuckets: Int): KLogPerBucketingStrategy<Any> {
            TODO()
        }
    }
}