 ...
 *
 * Often each {@link com.buenaflor.kflogger.AbstractLogger} instance will be instantiated with a
...
public abstract class LoggerBackend {
   ...
   *       of {@link com.buenaflor.kflogger.parser.ParseException ParseException} and contain
