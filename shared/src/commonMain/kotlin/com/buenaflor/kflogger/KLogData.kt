...
expect interface KLogData {
     ...
     *
     *
     * IMPORTANT: The returned instance is restricted to metadata added at the log site, and will
     * not include any scoped metadata to be applied to the log statement. To process combined log
     * site and scoped metadata, obtain or create a [MetadataProcessor].
     */
    ...
    /**
     * Returns a template key for this log statement, or `null` if the statement does not
