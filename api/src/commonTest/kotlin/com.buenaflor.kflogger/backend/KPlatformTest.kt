...
class KPlatformTest {
    ...
    private class CompileOnlyLogger(backend: KLoggerBackend) : KAbstractLogger<CompileOnlyLogger.Api>(backend) {
        ...
        /** Logging context implementing the fully specified API for this logger.  */ // VisibleForTesting
        ...
        companion object {
            ...
            fun forEnclosingClass(): CompileOnlyLogger {
                ...
                val loggingClass: String = KPlatform.getCallerFinder().findLoggingClass(
                    CompileOnlyLogger::class.toKlass()
                )
