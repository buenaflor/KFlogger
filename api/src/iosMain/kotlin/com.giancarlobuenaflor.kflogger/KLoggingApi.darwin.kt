...
public actual interface KLoggingApi<API : KLoggingApi<API>?> {
  /**
   ...
   *   aggregated.
   */
  public actual fun per(scopeProvider: KLoggingScopeProvider?): API
   ...
   */
  public actual fun withStackTrace(size: KStackSize?): API
   ...
   */
  public actual fun withInjectedLogSite(logSite: KLogSite?): API
