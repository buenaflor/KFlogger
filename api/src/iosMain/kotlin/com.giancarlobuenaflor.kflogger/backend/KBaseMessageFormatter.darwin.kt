...
import com.giancarlobuenaflor.kflogger.parameter.KDateTimeFormat
...
public actual open class KBaseMessageFormatter
protected actual constructor(
    context: KTemplateContext,
    private val args: Array<Any?>?,
    private val out: StringBuilder
) : KMessageBuilder<StringBuilder>(context), KParameterVisitor {
  public actual override fun addParameterImpl(termStart: Int, termEnd: Int, param: KParameter) {
  ...
  actual override fun visitDateTime(
      value: Any?,
  ...
  public actual companion object {
     ...
     */
    public actual fun appendFormattedMessage(data: KLogData, out: StringBuilder): StringBuilder {
      TODO("Not yet implemented")
    }
