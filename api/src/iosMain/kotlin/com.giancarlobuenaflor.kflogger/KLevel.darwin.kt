...
protected constructor(public val name: String, public val value: Int) {
  public actual companion object {
    ...
    public actual val OFF: KLevel
      get() = com.giancarlobuenaflor.kflogger.KLevel("OFF", Int.MAX_VALUE)
    ...
    public actual val SEVERE: KLevel
      get() = com.giancarlobuenaflor.kflogger.KLevel("SEVERE", 1000)
    ...
    public actual val WARNING: KLevel
      get() = com.giancarlobuenaflor.kflogger.KLevel("WARNING", 900)
    ...
    public actual val INFO: KLevel
      get() = com.giancarlobuenaflor.kflogger.KLevel("INFO", 800)
    ...
    public actual val CONFIG: KLevel
      get() = com.giancarlobuenaflor.kflogger.KLevel("CONFIG", 700)
    ...
    public actual val FINE: KLevel
      get() = com.giancarlobuenaflor.kflogger.KLevel("FINE", 500)
    ...
    public actual val FINER: KLevel
      get() = com.giancarlobuenaflor.kflogger.KLevel("FINER", 400)
    ...
    public actual val FINEST: KLevel
      get() = com.giancarlobuenaflor.kflogger.KLevel("FINEST", 300)
    ...
    public actual val ALL: KLevel
      get() = com.giancarlobuenaflor.kflogger.KLevel("ALL", Int.MIN_VALUE)
  }
}
