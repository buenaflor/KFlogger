...
public actual class KParseException(errorMessage: String, logMessage: String) : RuntimeException(errorMessage) {
    public companion object {
        ...
        private fun msg(errorMessage: String, logMessage: String, errorStart: Int, errorEnd: Int): String {
            ...
            if (errorStart > SNIPPET_LENGTH + ELLIPSIS.length) {
                out.append(ELLIPSIS).append(
                    logMessage,
                    errorStart - SNIPPET_LENGTH,
                    errorStart
                )
            } else {
