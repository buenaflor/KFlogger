 ...
 * enabled.
 */
actual open class KMetadataKey<T> {
    /**
     ...
     */
    actual fun safeEmit(value: T, kvh: KeyValueHandler) {
    }
     ...
     */
    protected actual open fun emit(
        value: T,
        kvh: KeyValueHandler
    ) {
    }
 ...
 */
actual val <T> KMetadataKey<T>.label: String get() = TODO()
 ...
 */
actual val <T> KMetadataKey<T>.bloomFilterMask: Long get() = TODO()
