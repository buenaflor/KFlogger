...
public actual interface KLogData {
  ...
  public actual fun getLevel(): KLevel
   ...
   */
  public actual fun getLogSite(): KLogSite?
   ...
   *   context).
   */
  public actual fun getArguments(): Array<Any?>?
   ...
   *   context exists).
   */
  public actual fun getLiteralArgument(): Any?
   ...
   * [.getLiteralArgument]).
   */
  public actual fun getTemplateContext(): KTemplateContext?
}
