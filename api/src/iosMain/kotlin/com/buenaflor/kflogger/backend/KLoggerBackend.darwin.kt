...
actual abstract class KLoggerBackend {
   ...
   */
  actual abstract fun isLoggable(lvl: KLevel): Boolean
   ...
   */
  actual abstract fun log(data: KLogData?)
   ...
   */
  actual abstract fun handleError(error: RuntimeException, badData: KLogData)
}
