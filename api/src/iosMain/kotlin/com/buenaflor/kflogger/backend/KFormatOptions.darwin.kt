...
public actual class KFormatOptions {
     ...
     */
    public actual fun filter(allowedFlags: Int, allowWidth: Boolean, allowPrecision: Boolean): KFormatOptions {
     ...
     * validated, but any format options passed through the `ParameterVisitor` interface must
     ...
     * [ParameterVisitor][com.buenaflor.kflogger.parameter.ParameterVisitor] interface must
     * be valid with respect to the associated [FormatChar] instance.
     *
    ...
    public actual companion object {
         ...
         * prefixed with an ASCII space (`' '`). This corresponds to the `' '` printf flag and
        ...
        /**
         * A formatting flag which specifies that for signed numeric output, positive values should be
         * prefixed with an ASCII plus (`'+'`). This corresponds to the `'+'` printf flag and
         * is valid for all signed numeric types.
         */
         ...
         * separator (often a ',') should be used. This corresponds to the `','` printf flag and
         * is valid for:
         *
         ...
         * available width. This corresponds to the `'-'` printf flag and is valid for all
         * `FormatChar` instances, though it must be specified in conjunction with a width value.
         */
         ...
         * necessary to fill the minimum width. This corresponds to the `'0'` printf flag and is
        ...
        public actual val default: KFormatOptions
            get() = TODO("Not yet implemented")
         ...
         */
        public actual fun parse(message: String, pos: Int, end: Int, isUpperCase: Boolean): KFormatOptions {
            TODO("Not yet implemented")
        }
