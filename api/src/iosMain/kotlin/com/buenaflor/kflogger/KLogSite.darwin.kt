...
public actual abstract class KLogSite : KLogSiteKey {
  public actual companion object {
     ...
     *
     *
     * Normally this value (if present) is extracted from the SourceFile attribute of the class
     * file (see the [JVM class
 * file format specification](https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-4.html#jvms-4.7.10) for more details).
     */
