...
public actual interface KParameterVisitor {
    /**
     ...
     */
    public actual fun visit(value: Any?, format: KFormatChar?, options: KFormatOptions?)
     ...
     * @param options formatting options.
     */
    public actual fun visitDateTime(value: Any?, format: KDateTimeFormat?, options: KFormatOptions?)
     ...
     *
     *
     * This method is intended for use by `Parameter` implementations which describe formatting
     * rules which cannot by represented by either [FormatChar] or [DateTimeFormat]. This
