...
actual interface KLoggingApi<API : KLoggingApi<API>?> {
   ...
   * take precedence.
   */
  actual fun withCause(cause: Throwable?): API
   ...
   * @throws IllegalArgumentException if `n` is not positive.
   */
  actual fun onAverageEvery(n: Int): API
   ...
   *   aggregated.
   */
  actual fun per(scopeProvider: KLoggingScopeProvider?): API
   ...
   */
  actual fun withInjectedLogSite(
   ...
   */
  actual fun logVarargs(message: String?, varargs: Array<Any?>?)
   ...
   */
  actual fun log(msg: String?, p1: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Any?, p2: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Any?, p2: Any?, p3: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Any?, p2: Any?, p3: Any?, p4: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Any?, p2: Any?, p3: Any?, p4: Any?, p5: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Any?, p2: Any?, p3: Any?, p4: Any?, p5: Any?, p6: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Any?, p2: Any?, p3: Any?, p4: Any?, p5: Any?, p6: Any?, p7: Any?)
  ...
  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Char)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Byte)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Short)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Int)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Long)
  // ---- Overloads for two arguments (to avoid auto-boxing and vararg array creation). ----
  /*
   * It may not be obvious why we need _all_ combinations of actual fundamental types here (because some
   * combinations should be rare enough that we can ignore them). However due to the precedence in
   * the Java compiler for converting actual fundamental types in preference to auto-boxing, and the need
   ...
   */
  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Any?, p2: Boolean)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Any?, p2: Char)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Any?, p2: Byte)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Any?, p2: Short)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Any?, p2: Int)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Any?, p2: Long)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Any?, p2: Float)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Any?, p2: Double)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Boolean, p2: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Char, p2: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Byte, p2: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Short, p2: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Int, p2: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Long, p2: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Float, p2: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Double, p2: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Boolean, p2: Boolean)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Char, p2: Boolean)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Byte, p2: Boolean)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Short, p2: Boolean)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Int, p2: Boolean)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Long, p2: Boolean)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Float, p2: Boolean)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Double, p2: Boolean)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Boolean, p2: Char)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Char, p2: Char)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Byte, p2: Char)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Short, p2: Char)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Int, p2: Char)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Long, p2: Char)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Float, p2: Char)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Double, p2: Char)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Boolean, p2: Byte)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Char, p2: Byte)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Byte, p2: Byte)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Short, p2: Byte)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Int, p2: Byte)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Long, p2: Byte)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Float, p2: Byte)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Double, p2: Byte)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Boolean, p2: Short)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Char, p2: Short)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Byte, p2: Short)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Short, p2: Short)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Int, p2: Short)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Long, p2: Short)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Float, p2: Short)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Double, p2: Short)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Boolean, p2: Int)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Char, p2: Int)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Byte, p2: Int)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Short, p2: Int)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Int, p2: Int)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Long, p2: Int)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Float, p2: Int)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Double, p2: Int)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Boolean, p2: Long)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Char, p2: Long)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Byte, p2: Long)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Short, p2: Long)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Int, p2: Long)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Long, p2: Long)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Float, p2: Long)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Double, p2: Long)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Boolean, p2: Float)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Char, p2: Float)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Byte, p2: Float)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Short, p2: Float)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Int, p2: Float)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Long, p2: Float)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Float, p2: Float)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Double, p2: Float)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Boolean, p2: Double)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Char, p2: Double)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Byte, p2: Double)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Short, p2: Double)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Int, p2: Double)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Long, p2: Double)

  /** Logs a message with formatted arguments (see [.log] for details). */
  actual fun log(msg: String?, p1: Float, p2: Double)
