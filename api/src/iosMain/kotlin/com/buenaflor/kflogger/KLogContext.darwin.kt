 ...
 */
public actual abstract class KLogContext<LOGGER : KAbstractLogger<API>, API : KLoggingApi<API>> : KLoggingApi<API>,
    KLogData {
    /**
    ...
    public actual final override fun wasForced(): Boolean { TODO() }
     ...
     * @param key the metadata key (see [LogData]).
     */
    protected actual fun removeMetadata(key: KMetadataKey<*>?) { TODO() }
    // ---- Post processing ----
    /**
     ...
     *
     *
     * Note that the given `logSiteKey` can be more specific than the [LogSite] of a
     ...
     */
    protected actual open fun postProcess(logSiteKey: KLogSiteKey?): Boolean { TODO() }

    /**
     * Callback to allow custom log contexts to apply additional rate limiting behaviour. This should
     * be called from within an overriden `postProcess()` method. Typically this is invoked
     * after calling `super.postProcess(logSiteKey)`, such as:
     *
     * <pre>`protected boolean postProcess( LogSiteKey logSiteKey) {
     * boolean shouldLog = super.postProcess(logSiteKey);
     ...
     *
     *
     * See [RateLimitStatus] for more information on how to implement custom rate limiting in
     * Flogger.
     *
     ...
     */
    protected actual fun updateRateLimiterStatus(status: KRateLimitStatus?): Boolean { TODO() }

    // ---- Log site injection (used by pre-processors and special cases) ----
    public actual final override fun withInjectedLogSite(logSite: KLogSite?): API { TODO() }
    ...
    // ---- Public logging API ----
    public actual final override fun isEnabled(): Boolean { TODO() }

    public actual final override fun <T> with(key: KMetadataKey<T>, value: T?): API { TODO() }

    public actual final override fun with(key: KMetadataKey<Boolean?>?): API { TODO() }

    public actual final override fun <T> per(key: T?, strategy: KLogPerBucketingStrategy<in T>): API { TODO() }

    public actual final override fun per(key: Enum<*>?): API { TODO() }

    public actual final override fun per(scopeProvider: KLoggingScopeProvider?): API { TODO() }

    public actual final override fun withCause(cause: Throwable?): API { TODO() }

    public actual final override fun withStackTrace(size: KStackSize?): API { TODO() }

    public actual final override fun every(n: Int): API { TODO() }

    public actual final override fun onAverageEvery(n: Int): API { TODO() }

    public actual final override fun atMostEvery(n: Int, unit: KTimeUnit?): API { TODO() }
   ...
   */
    public actual final override fun log() { TODO() }

    public actual final override fun log(msg: String?) { TODO() }
    public actual final override fun log(msg: String?, p1: Any?) { TODO() }
    public actual final override fun log(msg: String?, p1: Any?, p2: Any?) { TODO() }
    public actual final override fun log(
        msg: String?, p1: Any?, p2: Any?, p3: Any?
    ) { TODO() }
    ...
    public actual final override fun log(msg: String?, p1: Char) { TODO () }

    public actual final override fun log(msg: String?, p1: Byte) { TODO () }

    public actual final override fun log(msg: String?, p1: Short) { TODO () }

    public actual final override fun log(msg: String?, p1: Int) { TODO () }

    public actual final override fun log(msg: String?, p1: Long) { TODO () }

    public actual final override fun log(msg: String?, p1: Any?, p2: Boolean) { TODO() }

    public actual final override fun log(msg: String?, p1: Any?, p2: Char) { TODO() }

    public actual final override fun log(msg: String?, p1: Any?, p2: Byte) { TODO() }

    public actual final override fun log(msg: String?, p1: Any?, p2: Short) { TODO() }

    public actual final override fun log(msg: String?, p1: Any?, p2: Int) { TODO() }

    public actual final override fun log(msg: String?, p1: Any?, p2: Long) { TODO() }

    public actual final override fun log(msg: String?, p1: Any?, p2: Float) { TODO() } 

    public actual final override fun log(msg: String?, p1: Any?, p2: Double) { TODO() }

    public actual final override fun log(msg: String?, p1: Boolean, p2: Any?) { TODO() }
    public actual final override fun log(msg: String?, p1: Char, p2: Any?) { TODO() }
    public actual final override fun log(msg: String?, p1: Byte, p2: Any?) { TODO() }
    public actual final override fun log(msg: String?, p1: Short, p2: Any?) { TODO() }
    public actual final override fun log(msg: String?, p1: Int, p2: Any?) { TODO() }
    public actual final override fun log(msg: String?, p1: Long, p2: Any?) { TODO() }
    public actual final override fun log(msg: String?, p1: Float, p2: Any?) { TODO() }
    public actual final override fun log(msg: String?, p1: Double, p2: Any?) { TODO() }
    public actual final override fun log(msg: String?, p1: Boolean, p2: Boolean) { TODO() }

    public actual final override fun log(msg: String?, p1: Char, p2: Boolean) { TODO() }

    public actual final override fun log(msg: String?, p1: Byte, p2: Boolean) { TODO() }

    public actual final override fun log(msg: String?, p1: Short, p2: Boolean) { TODO() }

    public actual final override fun log(msg: String?, p1: Int, p2: Boolean) { TODO() }

    public actual final override fun log(msg: String?, p1: Long, p2: Boolean) { TODO() }

    public actual final override fun log(msg: String?, p1: Float, p2: Boolean) { TODO() }

    public actual final override fun log(msg: String?, p1: Double, p2: Boolean) { TODO() }

    public actual final override fun log(msg: String?, p1: Boolean, p2: Char) { TODO() }

    public actual final override fun log(msg: String?, p1: Char, p2: Char) { TODO() }

    public actual final override fun log(msg: String?, p1: Byte, p2: Char) { TODO() }

    public actual final override fun log(msg: String?, p1: Short, p2: Char) { TODO() }

    public actual final override fun log(msg: String?, p1: Int, p2: Char) { TODO() }

    public actual final override fun log(msg: String?, p1: Long, p2: Char) { TODO() }

    public actual final override fun log(msg: String?, p1: Float, p2: Char) { TODO() }

    public actual final override fun log(msg: String?, p1: Double, p2: Char) { TODO() }

    public actual final override fun log(msg: String?, p1: Boolean, p2: Byte) { TODO() }

    public actual final override fun log(msg: String?, p1: Char, p2: Byte) { TODO() }

    public actual final override fun log(msg: String?, p1: Byte, p2: Byte) { TODO() }

    public actual final override fun log(msg: String?, p1: Short, p2: Byte) { TODO() }

    public actual final override fun log(msg: String?, p1: Int, p2: Byte) { TODO() }

    public actual final override fun log(msg: String?, p1: Long, p2: Byte) { TODO() }

    public actual final override fun log(msg: String?, p1: Float, p2: Byte) { TODO() }

    public actual final override fun log(msg: String?, p1: Double, p2: Byte) { TODO() }

    public actual final override fun log(msg: String?, p1: Boolean, p2: Short) { TODO() }

    public actual final override fun log(msg: String?, p1: Char, p2: Short) { TODO() }

    public actual final override fun log(msg: String?, p1: Byte, p2: Short) { TODO() }

    public actual final override fun log(msg: String?, p1: Short, p2: Short) { TODO() }

    public actual final override fun log(msg: String?, p1: Int, p2: Short) { TODO() }

    public actual final override fun log(msg: String?, p1: Long, p2: Short) { TODO() }

    public actual final override fun log(msg: String?, p1: Float, p2: Short) { TODO() }

    public actual final override fun log(msg: String?, p1: Double, p2: Short) { TODO() }

    public actual final override fun log(msg: String?, p1: Boolean, p2: Int) { TODO() }

    public actual final override fun log(msg: String?, p1: Char, p2: Int) { TODO() }

    public actual final override fun log(msg: String?, p1: Byte, p2: Int) { TODO() }

    public actual final override fun log(msg: String?, p1: Short, p2: Int) { TODO() }

    public actual final override fun log(msg: String?, p1: Int, p2: Int) { TODO() }

    public actual final override fun log(msg: String?, p1: Long, p2: Int) { TODO() }

    public actual final override fun log(msg: String?, p1: Float, p2: Int) { TODO() }

    public actual final override fun log(msg: String?, p1: Double, p2: Int) { TODO() }

    public actual final override fun log(msg: String?, p1: Boolean, p2: Long) { TODO() }

    public actual final override fun log(msg: String?, p1: Char, p2: Long) { TODO() }

    public actual final override fun log(msg: String?, p1: Byte, p2: Long) { TODO() }

    public actual final override fun log(msg: String?, p1: Short, p2: Long) { TODO() }

    public actual final override fun log(msg: String?, p1: Int, p2: Long) { TODO() }

    public actual final override fun log(msg: String?, p1: Long, p2: Long) { TODO() }

    public actual final override fun log(msg: String?, p1: Float, p2: Long) { TODO() }

    public actual final override fun log(msg: String?, p1: Double, p2: Long) { TODO() }

    public actual final override fun log(msg: String?, p1: Boolean, p2: Float) { TODO() }

    public actual final override fun log(msg: String?, p1: Char, p2: Float) { TODO() }

    public actual final override fun log(msg: String?, p1: Byte, p2: Float) { TODO() }

    public actual final override fun log(msg: String?, p1: Short, p2: Float) { TODO() }

    public actual final override fun log(msg: String?, p1: Int, p2: Float) { TODO() }

    public actual final override fun log(msg: String?, p1: Long, p2: Float) { TODO() }

    public actual final override fun log(msg: String?, p1: Float, p2: Float) { TODO() }

    public actual final override fun log(msg: String?, p1: Double, p2: Float) { TODO() }

    public actual final override fun log(msg: String?, p1: Boolean, p2: Double) { TODO() }

    public actual final override fun log(msg: String?, p1: Char, p2: Double) { TODO() }

    public actual final override fun log(msg: String?, p1: Byte, p2: Double) { TODO() }

    public actual final override fun log(msg: String?, p1: Short, p2: Double) { TODO() }

    public actual final override fun log(msg: String?, p1: Int, p2: Double) { TODO() }

    public actual final override fun log(msg: String?, p1: Long, p2: Double) { TODO() }

    public actual final override fun log(msg: String?, p1: Float, p2: Double) { TODO() }

    public actual final override fun log(msg: String?, p1: Double, p2: Double) { TODO() }

    public actual final override fun logVarargs(message: String?, varargs: Array<Any?>?) { TODO() }}
...
public actual class KLogContextKey {
    public actual companion object {
         ...
         * Thus they are not available to the `postProcess()` method itself. The rationale is that
         ...
         * Users should never build new [Tags] instances just to pass them into a log statement.
         */
        // TODO KFlogger: val TAGS: KMetadataKey<com.buenaflor.kflogger.context.Tags>
        /**
         * The key associated with a [Throwable] cause to be associated with the log message. This
         * value is set by [LoggingApi.withCause].
         */
        ...
        /**
         * The key associated with a `Boolean` value used to specify that the log statement must
         * be emitted.
         *
         *
         * Forcing a log statement ensures that the `LoggerBackend` is passed the `LogData` for this log statement regardless of the backend's log level or any other filtering
...
public actual val <LOGGER : KAbstractLogger<API>, API : KLoggingApi<API>> KLogContext<LOGGER, API>.level: KLevel? get() = TODO()

@Deprecated("")
public actual val <LOGGER : KAbstractLogger<API>, API : KLoggingApi<API>> KLogContext<LOGGER, API>.timestampMicros: Long get() = TODO()

public actual val <LOGGER : KAbstractLogger<API>, API : KLoggingApi<API>> KLogContext<LOGGER, API>.timestampNanos: Long get() = TODO()

public actual val <LOGGER : KAbstractLogger<API>, API : KLoggingApi<API>> KLogContext<LOGGER, API>.loggerName: String? get() = TODO()

public actual val <LOGGER : KAbstractLogger<API>, API : KLoggingApi<API>> KLogContext<LOGGER, API>.logSite: KLogSite? get() = TODO()

// TODO KFlogger: public actual val <LOGGER : KAbstractLogger<API>, API : KLoggingApi<API>> KLogContext<LOGGER, API>.templateContext: TemplateContext

public actual val <LOGGER : KAbstractLogger<API>, API : KLoggingApi<API>> KLogContext<LOGGER, API>.arguments: Array<Any?>? get() = TODO()

public actual val <LOGGER : KAbstractLogger<API>, API : KLoggingApi<API>> KLogContext<LOGGER, API>.literalArguments: Any? get() = TODO()

public actual val <LOGGER : KAbstractLogger<API>, API : KLoggingApi<API>> KLogContext<LOGGER, API>.metadata: KMetadata? get() = TODO()
