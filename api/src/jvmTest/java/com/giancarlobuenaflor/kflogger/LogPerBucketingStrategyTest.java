...
import com.giancarlobuenaflor.kflogger.LogPerBucketingStrategy;
...
public final class LogPerBucketingStrategyTest {
  ...
  public void byClassName() {
    ...
    assertThat(LogPerBucketingStrategy.byClassName().apply(anyKey))
        .isSameInstanceAs("com.giancarlobuenaflor.kflogger.LogPerBucketingStrategyTest$NotASystemClass");
