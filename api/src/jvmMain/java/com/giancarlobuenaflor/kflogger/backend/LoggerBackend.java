 ...
 *
 * Often each {@link AbstractLogger} instance will be instantiated with a
...
public abstract class LoggerBackend {
   ...
   *       of {@link com.giancarlobuenaflor.kflogger.parser.ParseException ParseException} and contain
