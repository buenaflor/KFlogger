...
import com.giancarlobuenaflor.kflogger.backend.LoggingException;
import com.giancarlobuenaflor.kflogger.backend.MessageUtils;
import com.giancarlobuenaflor.kflogger.util.RecursionDepth;
...
public abstract class AbstractLogger<API extends LoggingApi<API>> {
   ...
   * only fail due to instances of {@link LoggingException} or {@link Error} being thrown.
   *
