...
import com.giancarlobuenaflor.kflogger.FluentLogger;
import com.giancarlobuenaflor.kflogger.MetadataKey;
import com.giancarlobuenaflor.kflogger.StackSize;
        ...
        LazyLogger.logger
            ...
            .log(
                "Scoped logging contexts are disabled; no context data provider was installed.\n"
                    ...
                    + "Default Platform: com.giancarlobuenaflor.kflogger.backend.system.DefaultPlatform");
      }
    }
