...
import static com.giancarlobuenaflor.kflogger.util.Checks.checkArgument;
import static com.giancarlobuenaflor.kflogger.util.Checks.checkMetadataIdentifier;
...
public final class Tags {
  ...
  private static class LightweightTagMap extends AbstractMap<String, Set<Object>> {
    ...
    private int copyEntryAndValues(
        Entry<String, SortedArraySet<Object>> entry,
        int entryIndex,
        int valueStart,
        Object[] array,
        int[] offsets) {
    ...
    private Entry<String, SortedArraySet<Object>> newEntry(String key, int index) {
    ...
    private Entry<String, SortedArraySet<Object>> getEntryOrNull(int index) {
      return index < offsets[0] ? (Entry<String, SortedArraySet<Object>>) array[index] : null;
    }
