 ...
 * enabled.
 */
public actual open class MetadataKey<T> private constructor(
    label: String,
    clazz: Class<out T>,
     ...
     */
    protected constructor(label: String, clazz: Class<out T>, canRepeat: Boolean) : this(label, clazz, canRepeat, true)
