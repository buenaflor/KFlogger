...
interface LoggingApi<API : LoggingApi<API>?> {
     ...
     * take precedence.
     */
    fun withCause(@NullableDecl cause: Throwable?): API
     ...
     */
    fun atMostEvery(n: Int, unit: TimeUnit?): API
     ...
     */
    fun <T> per(@NullableDecl key: T, strategy: LogPerBucketingStrategy<in T>?): API
     ...
     * and logging is aggregated by the unique combination of keys passed to all "per" methods.
     */
    fun per(@NullableDecl key: Enum<*>?): API
     ...
     * aggregated.
     */
    fun per(scopeProvider: LoggingScopeProvider?): API
     ...
     */
    fun withStackTrace(size: StackSize?): API
     ...
     * @see MetadataKey
     */
    fun <T> with(key: MetadataKey<T>?, @NullableDecl value: T): API
     ...
     * @see MetadataKey
     */
    fun with(key: MetadataKey<Boolean?>?): API
     ...
     */
    fun withInjectedLogSite(@NullableDecl logSite: LogSite?): API
     ...
     */
    fun logVarargs(message: String?, @NullableDecl varargs: Array<Any?>?)
     ...
     */
    fun log(msg: String?, @NullableDecl p1: Any?)

    /** Logs a message with formatted arguments (see [.log] for details).  */
    fun log(msg: String?, @NullableDecl p1: Any?, @NullableDecl p2: Any?)

    /** Logs a message with formatted arguments (see [.log] for details).  */
    fun log(msg: String?, @NullableDecl p1: Any?, @NullableDecl p2: Any?, @NullableDecl p3: Any?)
   ...
   */
    /** Logs a message with formatted arguments (see [.log] for details).  */
    fun log(msg: String?, @NullableDecl p1: Any?, p2: Boolean)

    /** Logs a message with formatted arguments (see [.log] for details).  */
    fun log(msg: String?, @NullableDecl p1: Any?, p2: Char)

    /** Logs a message with formatted arguments (see [.log] for details).  */
    fun log(msg: String?, @NullableDecl p1: Any?, p2: Byte)

    /** Logs a message with formatted arguments (see [.log] for details).  */
    fun log(msg: String?, @NullableDecl p1: Any?, p2: Short)

    /** Logs a message with formatted arguments (see [.log] for details).  */
    fun log(msg: String?, @NullableDecl p1: Any?, p2: Int)

    /** Logs a message with formatted arguments (see [.log] for details).  */
    fun log(msg: String?, @NullableDecl p1: Any?, p2: Long)

    /** Logs a message with formatted arguments (see [.log] for details).  */
    fun log(msg: String?, @NullableDecl p1: Any?, p2: Float)

    /** Logs a message with formatted arguments (see [.log] for details).  */
    fun log(msg: String?, @NullableDecl p1: Any?, p2: Double)

    /** Logs a message with formatted arguments (see [.log] for details).  */
    fun log(msg: String?, p1: Boolean, @NullableDecl p2: Any?)

    /** Logs a message with formatted arguments (see [.log] for details).  */
    fun log(msg: String?, p1: Char, @NullableDecl p2: Any?)

    /** Logs a message with formatted arguments (see [.log] for details).  */
    fun log(msg: String?, p1: Byte, @NullableDecl p2: Any?)

    /** Logs a message with formatted arguments (see [.log] for details).  */
    fun log(msg: String?, p1: Short, @NullableDecl p2: Any?)

    /** Logs a message with formatted arguments (see [.log] for details).  */
    fun log(msg: String?, p1: Int, @NullableDecl p2: Any?)

    /** Logs a message with formatted arguments (see [.log] for details).  */
    fun log(msg: String?, p1: Long, @NullableDecl p2: Any?)

    /** Logs a message with formatted arguments (see [.log] for details).  */
    fun log(msg: String?, p1: Float, @NullableDecl p2: Any?)

    /** Logs a message with formatted arguments (see [.log] for details).  */
    fun log(msg: String?, p1: Double, @NullableDecl p2: Any?)
     ...
     */
    open class NoOp<API : LoggingApi<API>?>() : LoggingApi<API> {
        ...
        override fun <T> with(key: MetadataKey<T>?, @NullableDecl value: T): API {
        ...
        override fun log(
            msg: String?, @NullableDecl p1: Any?, @NullableDecl p2: Any?, @NullableDecl p3: Any?
        ) {
        }
