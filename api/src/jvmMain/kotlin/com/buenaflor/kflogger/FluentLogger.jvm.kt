 ...
 */
public actual class FluentLogger internal constructor(backend: LoggerBackend) :
  ...
  internal inner class Context(level: Level?, isForced: Boolean) :
      LogContext<FluentLogger, Api>(level, isForced), Api {
  ...
  public actual companion object {
    ...
    // VisibleForTesting
    @JvmField internal val NO_OP = NoOp()
    ...
    public actual fun forEnclosingClass(): FluentLogger {
      ...
      val loggingClass = Platform.getCallerFinder().findLoggingClass(FluentLogger::class.java)
