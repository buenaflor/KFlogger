 ...
 */
public actual abstract class LogPerBucketingStrategy<T> protected actual constructor(name: String) {
   ...
   */
  @NullableDecl protected actual abstract fun apply(key: T): Any?
  ...
  public actual companion object {
     ...
     */
    @JvmStatic
    public actual fun knownBounded(): LogPerBucketingStrategy<Any> {
     ...
     */
    @JvmStatic
    public actual fun byClass(): LogPerBucketingStrategy<Any> {
      return BY_CLASS
    }
     ...
     */
    @JvmStatic
    public actual fun byClassName(): LogPerBucketingStrategy<Any> {
     ...
     */
    @JvmStatic
    public actual fun forKnownKeys(knownKeys: Iterable<*>): LogPerBucketingStrategy<Any> {
     ...
     */
    @JvmStatic
    public actual fun byHashCode(maxBuckets: Int): LogPerBucketingStrategy<Any> {
