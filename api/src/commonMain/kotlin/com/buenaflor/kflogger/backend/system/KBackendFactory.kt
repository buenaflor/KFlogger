 ...
 * [java.util.ServiceLoader] provided the proper service metadata is included in the jar file
 * containing the implementation. When creating an implementation of this class, you can provide
 * serivce metadata (and thereby allow users to get your implementation just by including your jar
 * file) by either manually including a
 * `META-INF/services/com.buenaflor.kflogger.backend.system.BackendFactory` file containing the name
 * of your implementation class or by annotating your implementation class using
 * [ `@AutoService(BackendFactory.class)`](https://github.com/google/auto/tree/master/service). See
 * the documentation of both [ ] and [DefaultPlatform] for more information.
 */
