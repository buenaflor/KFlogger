 ...
 * the current [ScopedLoggingContexts][com.buenaflor.kflogger.context.ScopedLoggingContext].
 *
 *
 ...
 * maps.
 */
expect abstract class KLoggingScope
    /**
     ...
     */
    // TODO protected abstract fun onClose(removalHook: java.lang.Runnable?)
    ...
    companion object {
        ...
        fun create(label: String?): KLoggingScope
    }
}
