...
public expect interface KLoggingApi<API : KLoggingApi<API>?> {
  /**
   ...
   *   aggregated.
   */
  public fun per(scopeProvider: KLoggingScopeProvider?): API
   ...
   */
  public fun withStackTrace(size: KStackSize?): API
   ...
   * @see MetadataKey
   */
  public fun with(key: KMetadataKey<Boolean?>?): API
   ...
   */
  public fun withInjectedLogSite(logSite: KLogSite?): API
   ...
   */
  public fun log(msg: String?, p1: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  public fun log(msg: String?, p1: Any?, p2: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  public fun log(msg: String?, p1: Any?, p2: Any?, p3: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  public fun log(msg: String?, p1: Any?, p2: Any?, p3: Any?, p4: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  public fun log(msg: String?, p1: Any?, p2: Any?, p3: Any?, p4: Any?, p5: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  public fun log(msg: String?, p1: Any?, p2: Any?, p3: Any?, p4: Any?, p5: Any?, p6: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  public fun log(msg: String?, p1: Any?, p2: Any?, p3: Any?, p4: Any?, p5: Any?, p6: Any?, p7: Any?)
   ...
   */
  /** Logs a message with formatted arguments (see [.log] for details). */
  public fun log(msg: String?, p1: Any?, p2: Boolean)

  /** Logs a message with formatted arguments (see [.log] for details). */
  public fun log(msg: String?, p1: Any?, p2: Char)

  /** Logs a message with formatted arguments (see [.log] for details). */
  public fun log(msg: String?, p1: Any?, p2: Byte)

  /** Logs a message with formatted arguments (see [.log] for details). */
  public fun log(msg: String?, p1: Any?, p2: Short)

  /** Logs a message with formatted arguments (see [.log] for details). */
  public fun log(msg: String?, p1: Any?, p2: Int)

  /** Logs a message with formatted arguments (see [.log] for details). */
  public fun log(msg: String?, p1: Any?, p2: Long)

  /** Logs a message with formatted arguments (see [.log] for details). */
  public fun log(msg: String?, p1: Any?, p2: Float)

  /** Logs a message with formatted arguments (see [.log] for details). */
  public fun log(msg: String?, p1: Any?, p2: Double)

  /** Logs a message with formatted arguments (see [.log] for details). */
  public fun log(msg: String?, p1: Boolean, p2: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  public fun log(msg: String?, p1: Char, p2: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  public fun log(msg: String?, p1: Byte, p2: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  public fun log(msg: String?, p1: Short, p2: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  public fun log(msg: String?, p1: Int, p2: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  public fun log(msg: String?, p1: Long, p2: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  public fun log(msg: String?, p1: Float, p2: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  public fun log(msg: String?, p1: Double, p2: Any?)
