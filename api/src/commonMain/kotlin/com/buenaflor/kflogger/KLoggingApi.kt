...
expect interface KLoggingApi<API : KLoggingApi<API>> {
  ...
  /** Logs a message with formatted arguments (see [.log] for details). */
  fun log(msg: String?, p1: Any?, p2: Any?, p3: Any?, p4: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  fun log(msg: String?, p1: Any?, p2: Any?, p3: Any?, p4: Any?, p5: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  fun log(msg: String?, p1: Any?, p2: Any?, p3: Any?, p4: Any?, p5: Any?, p6: Any?)

  /** Logs a message with formatted arguments (see [.log] for details). */
  fun log(msg: String?, p1: Any?, p2: Any?, p3: Any?, p4: Any?, p5: Any?, p6: Any?, p7: Any?)
...
expect open class KLoggingApiNoOp<API : KLoggingApi<API>>() : KLoggingApi<API> {
  ...
  final override fun log(msg: String?, p1: Any?, p2: Any?, p3: Any?, p4: Any?)

  final override fun log(msg: String?, p1: Any?, p2: Any?, p3: Any?, p4: Any?, p5: Any?)

  final override fun log(msg: String?, p1: Any?, p2: Any?, p3: Any?, p4: Any?, p5: Any?, p6: Any?)
