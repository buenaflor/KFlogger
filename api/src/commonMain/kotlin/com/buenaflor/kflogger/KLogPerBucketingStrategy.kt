...
expect abstract class KLogPerBucketingStrategy<T> protected constructor(name: String?) {
   ...
   * small, the set of distinct allocated instances passed to [ ][KLoggingApi.per] can be unbounded,
  ...
  companion object {
     ...
     *
     * *WARNING*: When using this strategy, keys passed to [ ][KLoggingApi.per] are used as-is by
     * the log aggregation code, and held indefinitely by internal static data structures. As such
     * it is vital that key instances used with this strategy have singleton semantics (i.e. if
     ...
     * use of non-singleton keys in [&lt;][KLoggingApi.per].
     *
