 ...
 *
 * WARNING: Many date/time format specifiers use the system default time-zone for formatting `Date`
 * or `long` arguments. This makes it non system-portable, and its use is heavily discouraged with
 * non-`Calendar` arguments.
 */
public expect enum class KDateTimeFormat {
  ...
  /**
   * Seconds within the minute, formatted as two digits with a leading zero as necessary, i.e. 00 -
  ...
  public companion object {
    public fun of(c: Char): KDateTimeFormat?
  }
}

public expect val KDateTimeFormat.char: Char
