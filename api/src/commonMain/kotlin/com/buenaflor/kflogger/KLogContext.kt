 ...
 */
public expect abstract class KLogContext<LOGGER : KAbstractLogger<API>, API : KLoggingApi<API>> : KLoggingApi<API>,
    KLogData {
...
public expect val <LOGGER : KAbstractLogger<API>, API : KLoggingApi<API>> KLogContext<LOGGER, API>.level: KLevel?

@Deprecated("")
public expect val <LOGGER : KAbstractLogger<API>, API : KLoggingApi<API>> KLogContext<LOGGER, API>.timestampMicros: Long

public expect val <LOGGER : KAbstractLogger<API>, API : KLoggingApi<API>> KLogContext<LOGGER, API>.timestampNanos: Long

public expect val <LOGGER : KAbstractLogger<API>, API : KLoggingApi<API>> KLogContext<LOGGER, API>.loggerName: String?

public expect val <LOGGER : KAbstractLogger<API>, API : KLoggingApi<API>> KLogContext<LOGGER, API>.logSite: KLogSite?
...
public expect val <LOGGER : KAbstractLogger<API>, API : KLoggingApi<API>> KLogContext<LOGGER, API>.arguments: Array<Any?>?

public expect val <LOGGER : KAbstractLogger<API>, API : KLoggingApi<API>> KLogContext<LOGGER, API>.literalArguments: Any?

public expect val <LOGGER : KAbstractLogger<API>, API : KLoggingApi<API>> KLogContext<LOGGER, API>.metadata: KMetadata?
