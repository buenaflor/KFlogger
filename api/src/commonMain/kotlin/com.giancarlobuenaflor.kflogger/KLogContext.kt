...
public expect abstract class KLogContext<LOGGER : KAbstractLogger<API>, API : KLoggingApi<API>> :
  ...
  public final override fun getLevel(): KLevel

  @Deprecated("") public final override fun getTimestampMicros(): Long

  public final override fun getTimestampNanos(): Long
  ...
  public final override fun getLiteralArgument(): Any?
   ...
   */
  public final override fun getMetadata(): KMetadata
